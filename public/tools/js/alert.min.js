...
// dialog(type,[text,title],{cancel:[text,url],confirm:[text,url]})
function dialog(type, config, active)
{
	var icon='error',title='错误提示',text='',b1='OK',b2=false,outsideClick=true;
	...
	if (typeof active != 'undefined') {
		...
		if (active.hasOwnProperty("cancel")) {
			// 定义了取消按钮
		    b1 = active.cancel;
			if (typeof active.cancel == 'Object') {
			    b1 = active.cancel[0];
		        if (typeof cancel[1] != 'undefined') {
		...
		if (active.hasOwnProperty("confirm")) {
			// 定义了取消按钮
		    b2 = active.confirm;
